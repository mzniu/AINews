...
from src.utils.paths import ensure_runtime_dirs, get_config_dir, get_data_dir, get_resource_dir, load_runtime_dotenv
...
class Config:
    ...
    OUTPUT_DIR = os.getenv("OUTPUT_DIR", str(DATA_DIR / "videos"))
